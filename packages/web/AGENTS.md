...
- `@depot/core/utils/{datasheets,wargear,abilities,roster,collection,paths,detachments,model-costs}`: canonical normalization + data builders used by hooks/routes.

...
const PrivacyPolicy = () => (
  <AppLayout title="Privacy Policy">
    <div className="flex flex-col gap-2">
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Application Data</h2>
        <p className="text-sm text-gray-700 dark:text-gray-300">
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Hosting & Analytics</h2>
        <p className="text-sm text-gray-700 dark:text-gray-300">
      ...
      <section className="flex flex-col gap-2">
        <h3 className="text-md font-semibold text-gray-900 dark:text-white">Error Reporting</h3>
        <p className="text-sm text-gray-700 dark:text-gray-300">
          depot uses{' '}
      ...
      <section className="flex flex-col gap-2">
        <h3 className="text-md font-semibold text-gray-900 dark:text-white">Data Sharing</h3>
        <p className="text-sm text-gray-700 dark:text-gray-300">
      ...
      <section className="flex flex-col gap-2 text-xs text-gray-500 dark:text-gray-400">

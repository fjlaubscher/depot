  ...
  return (
    <dialog
      ...
      className={cx(
        ...
        'backdrop:bg-surface-overlay backdrop:opacity-0 open:backdrop:opacity-100 backdrop:transition-all backdrop:transition-discrete backdrop:duration-200 starting:open:backdrop:opacity-0',
        isBottom

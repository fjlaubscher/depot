...
export const init = async (factions: Wahapedia.Faction[]) => {
...
export const getFaction = (factionId: string): Promise<Wahapedia.Faction> =>
  new Promise(async (resolve, reject) => {
    ...
    request.onsuccess = () => {
      connection.close();
      return resolve(request.result as Wahapedia.Faction);
    };
    request.onerror = () => {
      connection.close();
